RU-Spring-2018L Molecular View of Human Anatomy: Molecular Mechanisms of Antibiotics Action and Resistance and the [Comprehensive Antibiotic Resistance Database](http://card.mcmaster.ca)
--------------------------------------------
